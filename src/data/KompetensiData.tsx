...
export const kompetensiData: Record<string, KompetensiDetail> = {
    ...
    kategori: [
      {
        ...
        items: [
          ...
          {
            id: "J.620100.010.01",
            nama: "Menerapkan Perintah Eksekusi Bahasa Pemograman Berbasis Teks, Grafik, dan Multimedia",
          },
          {
            id: "J.620100.016.01",
            nama: "Menulis Kode dengan Prinsip sesuai Guidelines dan Best Practices",
          },
          {
            id: "J.620100.017.02",
            nama: "Mengimplementasikan Pemograman Terstruktur",
          },
      ...
      },
      {
        ...
        items: [
          ...
          {
            id: "J.620100.011.01",
            nama: "Melakukan Instalasi Software Tools Pemograman",
          },
          {
            id: "J.620100.012.01",
            nama: "Melakukan Pengaturan Software Tools Pemograman",
          },
          {
            id: "J.620100.016.01",
            nama: "Menulis Kode dengan Prinsip sesuai Guidelines dan Best Practices",
    ...
    kategori: [
      {
        ...
        items: [
          {
            id: "M.692000.001.02",
            nama: "Menerapkan Prinsip Praktik Profesional dalam Bekerja",
          },
          {
            id: "M.692000.002.02",
            nama: "Menerapkan Praktik - Praktik Kesehatan dan Keselamatan di Tempat Kerja",
          },
          ...
          {
            id: "M.692000.022.02",
            nama: "Mengoperasikan Paket Program Pengolah Angka/ Spreadsheet",
          },
          {
            id: "M.692000.023.02",
  ...
  "3": {
    ...
    kategori: [
      {
        nama: "Staff Admininstrasi",
        icon: "Users",
        items: [
          {
            id: "N.821100.001.02",
            nama: "Menangani Penerimaan/ Pengiriman Surat/ Dokumen",
          },
          { id: "N.821100.004.02", nama: "Memproduksi Dokumen" },
          {
            id: "N.821100.028.02",
            nama: "Mengaplikasikan Keterampilan Dasar Komunikasi",
          },
          {
            id: "N.821100.029.02",
            nama: "Melakukan Komunikasi Melalui Telepon",
          },
          {
            id: "N.821100.030.02",
            nama: "Melakukan Komunikasi Lisan dengan Kolega/Pelanggan",
          },
          {
            id: "N.821100.032.02",
            nama: "Melakukan Komunikasi Lisan dalam Bahasa Inggris pada Tingkat Operasional Dasar",
          },
          {
            id: "N.821100.033.02",
            nama: "Membaca dalam Bahasa Inggris pada Tingkat Operasional Dasar",
          },
          ...
          {
            id: "N.821100.059.02",
            nama: "Menggunakan Peralatan dan Sumberdaya Kerja",
          },
          {
            id: "N.821100.067.01",
            nama: "Melakukan Transaksi Perbankan Sederhana",
          },
          ...
          {
            id: "N.821100.002.02",
            nama: "Mengatur Penggandaan/Pengumpulan Surat/Dokumen",
          },
          {
            id: "N.821100.003.02",
          ...
          {
            id: "N.821100.034.02",
            nama: "Menulis dalam Bahasa Inggris pada Tingkat Operasional Dasar",
          },
          {
            id: "N.821100.041.01",
            nama: "Menulis Pesan Singkat dalam Bahasa Inggris",
          },
          {
            id: "N.821100.045.02",
            nama: "Memberikan Layanan kepada Pelanggan",
          },
          ...
          {
            id: "N.821100.061.01",
            nama: "Mengakses Informasi melalui Homepage",
          },
        ],
      },
    ],
    ...
    kategori: [
      {
        ...
        items: [
          ...
          {
            id: "G.46RIT00.002.1",
            nama: "Menjalankan Tugas dan Tanggung Jawab Pribadi",
          },
          {
            id: "G.46RIT00.003.1",
            nama: "Mengoperasikan Peralatan Dasar Ritel",
          },
          {
            id: "G.46RIT00.004.1",
            nama: "Membangun Perilaku Kerja Ritel yang Efektif",
          },
          {
            id: "G.46RIT00.008.1",
            nama: "Berkomunikasi Aktif dalam Lingkungan Kerja Ritel",
          },
          {
            id: "G.46RIT00.018.1",
            nama: "Menerapkan Perilaku Kerja Aman di Gerai Ritel",
          },
          { id: "G.46RIT00.005.1", nama: "Melakukan Pengemasan Barang Dagang" },
          {
            id: "G.46RIT00.026.1",
            nama: "Membantu Pelaksanaan Perhitungan Stok Barang Dagang",
          },
          {
            id: "G.46RIT00.031.1",
            nama: "Melakukan Kegiatan Pemajangan Barang Dagang (Display)",
          },
        ],
      },
      {
